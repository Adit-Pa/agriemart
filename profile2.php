...
if(isset($_POST['update1']))
{
	...
	$result = mysqli_query($con, "UPDATE post SET desci='$desci',price='$price' WHERE postid='$postid'");
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group input-group-alternative">
                                                ...
                                                <textarea class="form-control" placeholder="Add desciription" name="descii" value=" "></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<hr id="croptab1">
        ...
        <div class="card card-profile shadow mt--300" >
          <div class="px-4">
            <div class="row justify-content-center" >
              ...
              <div class="col-lg-4 order-lg-3 text-lg-right align-self-lg-center">
                <div class="card-profile-actions py-4 mt-lg-0" style="margin-top: 40px;padding: 0px !important;">
				
				
                  <input type="submit" value="update" name="update1" class="btn btn-sm btn-info mr-4">
				  <a href=delete.php?id='.$res[postid].' class="btn btn-sm btn-info mr-4">Delete</a>
    ...
    max-width: 100%;">
            ...
            <div class="pl-lg-4">
            <input class="form-control" placeholder="desciription" type="hidden" name="postid" value="'.$res['postid'].'">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">desciription</label>
                         <input class="form-control" placeholder="desciription" type="text" name="desci" value="'.$res['desci'].'">
                         </div>
                    </div>
            	</div>
                      <div class="row">
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Price" type="text" name="price" value="'.$res['price'].'">
                     </div>
                     </div>
                     </div>
                     </div>
